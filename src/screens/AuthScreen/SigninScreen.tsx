                ...
                >
                    <View style={{
                        ...
                        <View style={{ alignItems: "center" }}>
                            <Text style={{ fontSize: 24, color: "#121212" }}>Sign in.</Text>
                            <Text style={{ color: "#757575", fontSize: 11 }}>Authentication Required..</Text>
                        </View>
                        ...
                        >
                            <Text style={{ color: "#8B5CF6", textAlign: "center", textDecorationLine: "underline" }}>Don't have account..Sign up!!</Text>
                        </TouchableOpacity>
                    </View>
                </ScrollView>
            </KeyboardAvoidingView>
